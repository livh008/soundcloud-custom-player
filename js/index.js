...
(function($) {
  ...
  var apiKey,
      ...
      updateTrackInfo = function($player, track) {
        ...
        $('.sc-waveform-container', $player).html('<img class="sc-waveform-image" src="' + track.waveform_url +'" />');
    ...
    $doc
      ...
      .bind('scPlayer:onMediaPlay', function(event) {
		...
		//play rotateReels animation
		document.getElementById("reelL").className = "playingReels";
		document.getElementById("reelR").className = "playingReels";
      ...
      .bind('scPlayer:onMediaPause', function(event) {
        clearInterval(positionPoll);
        positionPoll = null;
		//stop rotateReels animation
	      document.getElementById("reelL").className = "pausedReels";
		  document.getElementById("reelR").className = "pausedReels";	 
      })
      // change the volume
    ...
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $player.bind('onTrackDataLoaded.scPlayer', function(event) {
          ...
          $player.each(function() {
			...
			//display the right cassette face for each track
			function myFunction() {
			 var selectedTrack = $("a").text();	
		     var isDemo = selectedTrack.includes("Demo");
			 var isMorissimo = selectedTrack.includes("morissimo");
    			if (isDemo) {
                 document.getElementById("test").innerHTML = "isDemo is true";
                } else if (isMorissimo) {
                document.getElementById("test").innerHTML = "isMorissimo is true";
                } else {
                document.getElementById("test").innerHTML = "isDemo and isMorissimo are false";
                }
			}
            myFunction();
